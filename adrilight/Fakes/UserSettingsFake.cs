...
namespace adrilight.Fakes
{
    class UserSettingsFake : IUserSettings
    {
        ...
        public string AdrilightVersion { get; set; } = "3.7.2";
        ...
        public bool SoundToLightAutoBpm    { get; set; } = true;
        public bool SoundToLightBandSpread { get; set; } = false;
        public int  AdapterIndex    { get; set; } = 0;
        public int  OutputIndex     { get; set; } = 0;
        public bool SpanningEnabled { get; set; } = false;
        public int  AdapterIndex2   { get; set; } = 0;
        public int  OutputIndex2    { get; set; } = 0;
